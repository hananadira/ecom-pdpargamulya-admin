        ...
        <div className="container mt-5 mb-5">
            <div className="row">
                <div className="col-md-12">
                    <Link to="/posts/create" className="btn btn-md btn-success rounded shadow border-0 mb-3">ADD NEW PRODUK</Link>
                                            ...
                                            ?   posts.map((post, index) => (
                                                    <tr key={ index }>
                                                        <td className='text-center'>
                                                            <img src={post.photo_product} alt={post.description} width="200" className='rounded' />
                                                        </td>
                                                        <td>{ post.name }</td>
                                                        <td>{ post.price }</td>
                                                        <td className="text-center">
