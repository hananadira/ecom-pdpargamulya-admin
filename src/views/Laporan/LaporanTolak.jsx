...
import { useGetLaporansTolakQuery, useDeleteLaporanMutation } from "../../redux/services/LaporanApi";
...
const LaporanTolak = () => {
  const { data, error, isLoading } = useGetLaporansTolakQuery();
