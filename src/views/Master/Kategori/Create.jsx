...
import { useCreateKategoriMutation } from '../../../redux/services/ProductApi';
...
const AddKategori = () => {
  ...
  const [createKategori] = useCreateKategoriMutation();
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const kategoriPayload = new FormData();
      kategoriPayload.append('name_category', formData.name_category);

      await createKategori(kategoriPayload).unwrap();
  ...
  return (
    <div className="container mx-auto p-8 bg-white shadow-md rounded-md">
      <div className="flex items-center mb-5">
        ...
        <Typography variant="h5" className="font-bold">Tambah Kategori</Typography>
